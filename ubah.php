...
<body background="img/bg/ryzl1.png">
     <!-- Navbar -->
                         ...
                         <div class="mb-3">
                              ...
                              <select class="form-select w-50" id="jurusan" name="jurusan">
                                   <option disabled selected value>--------------------------------------------Pilih
                                        Jurusan--------------------------------------------</option>
                                   <option value="Informatika" <?php if ($siswa['jurusan'] == 'Informatika') { ?>
                                        selected='' <?php } ?>>Informatika</option>
                                   <option value="Teknik Sipil"
                                        <?php if ($siswa['jurusan'] == 'Teknik Sipil') { ?> selected=''
                                        <?php } ?>>Teknik Sipil</option>
                                   <option value="Teknik Lingkungan" <?php if ($siswa['jurusan'] == 'Teknik Lingkungan') { ?>
                                        selected='' <?php } ?>>Teknik Lingkungan</option>
                              </select>
                         </div>
                         <div class="mb-3">
    ...
    <div class="container-fluid">
          <div class="row eow-expand-lg row-dark bg-dark  text-white text-center">
               <div class="col my-2">
               <button class="row-toggler"  data-bs-toggle="collapse" data-bs-target="#navbarNav"
                    aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">

               </button>
                    <p>copyright & copy; 2023 - Fahrizal. All Rights Reserved.</p>
               </div>
          </div>
     </div>
