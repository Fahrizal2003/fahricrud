...
<body background="img/bg/izal.png">
     <!-- Navbar -->
     <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
          <div class="container">
               <a class="navbar-brand" href="index.php">Biodata Mahasiswa</a>
                         ...
                         <tbody>
                              ...
                              <tr class="table-secondary text-dark">
                                ...
                                ?>
                                   ...
                                   <td><?= $row['jurusan']; ?></td>
                                   <td>
                                        <button class="btn btn-outline-success btn-sm text-dark detail"
                                        ...
                                        <a href="ubah.php?nis=<?= $row['nis']; ?>" class="btn btn-outline-warning btn-sm text-dark detail"
                                             style="font-weight: 600;"><i class="bi bi-pencil-square"></i>Ubah</a> |

                                        <a href="hapus.php?nis=<?= $row['nis']; ?>" class="btn btn-outline-danger"
